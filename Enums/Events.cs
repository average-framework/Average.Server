namespace Average.Server.Enums
{
    internal static class Events
    {
        ...
        internal const string ResourceStarting = "ResourceStarting";
        internal const string ServerResourceStart = "ServerResourceStart";
        internal const string ServerResourceStop = "ServerResourceStop";
